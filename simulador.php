...
<body>
    ...
    <form action="simulador.php" method="POST">
        ...
        <label for="femenino">Fémenino</label> <br>
        ...
        <?php
            ...
            foreach($siNo as $rubro){
                ...
                echo "<label for='no$postName'>No</label> <br>";
            ...
            foreach($servInternet as $rubro){
                ...
                echo "<label for='no$postName'>No</label> <br>";
                echo "<input type='radio' value='1' name='$postName' id='si$postName'>";
                echo "<label for='si$postName'>Sí</label> <br>";
        ...
        ?>
        <br>
        <input type="submit" value="Calcular abandono" name="submit">
    </form>
    <?php
